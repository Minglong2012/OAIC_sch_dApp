                                           ...
                                           uint32_t                tb)
{
  ...
  ///////////////////////////////////////////////////////////
  //std::cout <<"RBG mask = ";
  //for (size_t i = user_mask.size(); i > 0; --i) {
  //  std::cout << (user_mask.test(i - 1) ? '1' : '0');
  //}
  //std::cout<<std::endl;
  ////////////////////////////////////////////////////////////
...
void probe_rbg_mask(const rbgmask_t& mask){
  // print rbg_mask contents to file

  //std::string s;
  //s.assign(mask.size(), '0');

  // std::cout <<"123 RBG mask = ";
  // for (size_t i = mask.size(); i > 0; --i) {
  //   std::cout << (mask.test(i - 1) ? '1' : '0');
  // }
  // std::cout<<std::endl;
                                     ...
                                     const rbgmask_t&                  user_mask)
{
  ...
  // }
  // std::cout<<std::endl;
  // std::cout<<"cqi="<<cells[enb_cc_idx].get_dl_cqi()<<std::endl;
  ////////////////////////////////////////////////////////////
